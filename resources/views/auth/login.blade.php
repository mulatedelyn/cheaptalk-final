...
<body>
    <div class="container col-md-3 offset-md-3.5">
        ...
        @endif
        <div class="card shadow mb-5 rounded border border-outline-light mt-5">
            <div class="card-body rounded" style="background-color: #333333;" id="card-bodyy">
                <h2 class="text-center mb-4" style="color:#c6e3a4; font-size: 25px;">Log In</h2>
                <form action="{{ '/' }}" method="POST">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="form-group text-center mt-4 mr-4">
                            <button class="btn btn-outline-info" id="actionBtn" type="submit"><img src="https://cdn-icons-png.flaticon.com/512/3580/3580148.png" width="20" height="20" class="rounded"> Login</button>
                        </div>
                    </div>
                    </form>
            </div>
