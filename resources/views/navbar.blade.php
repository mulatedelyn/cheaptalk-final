<nav class="navbar navbar-expand-lg navbar-light shadow" style="background-color:#23242c;">

    <h2 class="p-2 text-white" style="font-size:23px; font-weight:400;"><span class="fas fa-comments"></span>Cheap Talk</h2>
    ...
    <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav d-flex align-items-end justify-content-end">
            ...
            @role('admin')
                ...
                <div class="dropdown">
                    <a class="btn dropdown-toggle text-white bg-success bg-opacity-75" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><span class="fas fa-address-book"></span>
                        Admin
                    </a>
