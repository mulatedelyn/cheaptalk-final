<div class="div">
    ...
    <div class="container ">
        <div class="profile">
            <h2 class="mt-3 text-center" style="font-size: 23px; color: white;">{{Auth::user()->name}}'s Profile</h2>
        </div>
        <div class="post-body">
            <div class="col-md-6" style="width: 560px">
                <div class=" shadow-md p-3 " id="write">
                    <button class="write-2 form-control" style="color:white;background-color: transparent;" data-toggle="modal" data-target="#click">+ Create new talk</button>
                </div>
            </div>
            ...
            <div class="col-md-6  offset-2">
                ...
                <div class="card shadow-md mt-3 {{ $post->user->gender === 'Female' ? 'f1' : 'm1' }}"  style="width: 900px">
                    ...
                    <div class="card-body bg-secondary opacity-80">
